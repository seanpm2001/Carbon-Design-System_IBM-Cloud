...
<Canvas>
  <Story
    ...
    args={{
      items: [
        { href: '#example-item-1A', label: 'Link 1A', icon: Bee },
        { href: '#example-item-1B', label: 'Link 1B', icon: Bee},
        { icon: Bee, label: ' Nav List', items: [
            {href: '#example-item-2A', label: 'Link 2A'},
            {href: '#example-item-2B', label: 'Link 2B'}
          ]},
        { href: '#example-item-3A', label: 'Link 3A', icon: Bee},
        {  icon: Bee, label: 'Sub menu 1', items: [
