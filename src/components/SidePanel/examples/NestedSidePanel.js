...
const NestedPanelTwoContent = ({ setActivePanelById }) => (
  <Button
    onClick={() => {
      setActivePanelById(secondPanelId);
    }}
  >
    Render Second Panel
  </Button>
...
const NestedSidePanel = ({ showSidePanel, onPanelClose }) => {
  const nestedPanels = [
    <SidePanel
  ...
  return (
    ...
    >
      ...
      <SidePanel title="Forth Panel" id="panel-4">
        Forth Panel Content
      </SidePanel>
      <SidePanel title="Fifth Panel" id="panel-5">
        Fifth Panel Content
      </SidePanel>
    </SidePanelContainer>
  );
...
NestedSidePanel.code = `const SecondPanelContent = ({ setActivePanelById }) => (
  <>
    <Button
      onClick={() => setActivePanelById(nestedPanelOneId)}
      data-focus-first
    >
      Render First Nested Panel
    </Button>
  </>
);
...
const NestedPanelTwoContent = ({ setActivePanelById }) => (
  <>
    <Button onClick={() => setActivePanelById(secondPanelId)} data-focus-first>
      Render Second Panel
    </Button>
  </>
);
...
export default NestedSidePanel;
