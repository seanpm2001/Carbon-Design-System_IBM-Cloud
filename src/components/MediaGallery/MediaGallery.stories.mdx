...
export const mediaExample = [
  ...
  {
    type: 'image',
    url: 'https://picsum.photos/id/35/2758/3622',
    alt: 'A random large portrait image'
  },
  {
    type: 'image',
    url: 'https://dev.w3.org/SVG/tools/svgweb/samples/svg-files/duck.svg',
    alt: 'An SVG'
  }, 
  {
    type: 'image',
...
2.  Import the styles:
    ...
    ```js
    @import 'carbon-for-ibm-cloud/components/MediaGallery/styles';
    ```

3.  Import the component:

    ```js
    import { MediaGallery } from 'carbon-for-ibm-cloud/components';
    ```
